...
public class GamePanel extends JPanel implements ActionListener {
    ...
    private JTextField addCustomizeValue = new JTextField();
    private JButton addCustomize = new JButton("Aposta personalizada");
    ...
    public GamePanel() {
        ...
        addCustomizeValue.setPreferredSize(new Dimension(50, 24));
        table = new GameTable();
        ...
        betPanel.add(addCustomizeValue);
        betPanel.add(addCustomize);
        ...
        addCustomize.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (act.equals("Dar as cartas")) {
            ...
            stand();
        } else if (act.equals("R$ 1") || act.equals("R$ 5") || act.equals("R$ 10") || act.equals("R$ 25")
                || act.equals("R$ 100")) {
            ...
            clearBet();
        } else if(act.equals("Aposta personalizada")){
            System.out.print("aposta personalizada");
            increaseBet(Integer.parseInt(addCustomizeValue.getText()));
        }
    ...
    public void updateValues() {
        dealerSays.setText("<html><p align=\"center\"><font face=\"Serif\" color=\"white\" style=\"font-size: 24px\">"
        ...
        cardsLeft.setText(
                "Baralho: " + dealer.cardsLeftInPack() + "/" + (dealer.CARD_PACKS * Cards.CardPack.CARDS_IN_PACK));
    ...
    private void moreFunds() {
        int response = JOptionPane.showConfirmDialog(null, "Marshall Aid. Mil dólares. Com os cumprimentos dos EUA.",
                "Acabou o dinheiro", JOptionPane.YES_NO_OPTION);
    ...
    public void savePlayer() {
        if (dealer.isGameOver()) {
            ...
            JOptionPane.showMessageDialog(this, "Não é possível salvar o perfil enquauto o jogo está acontecendo!",
    ...
    public void openPlayer() {
        if (dealer.isGameOver()) {
            ...
            JOptionPane.showMessageDialog(this, "Não é possível abrir outro perfil enquanto o jogo está em progresso.",
